                ...
                <ul class="main__cards">
                    @foreach($groups as $group)
                        <li class="main__card" style="--hue: 231;">
                            ...
                            <h3 class="main__card-heading">{{$group->name}}</h3>
                            <p class="main__card-heading-sub">{{$group->description}}</p>
                            <p class="main__card-heading-sub">Цена:{{$group->price}}</p>
                            <p class="main__card-heading-sub">Количество занятий:{{$group->number_of_lessons}}</p>
                            <p class="main__card-heading-sub">Максимальное количество участников:{{$group->max_number_of_participants}}</p>
                            <p class="main__card-heading-sub">Фактическое количество участников:{{$group->actual_number_of_participants}}</p>
                            <p><input type="hidden" name="group_id">{{$group->id}}</p>
                            <h1 class="header__heading"><a href="note" target="_blank" rel="noreferrer noopener">Записаться</a></h1>
                        </li>
                    @endforeach
                </ul>
