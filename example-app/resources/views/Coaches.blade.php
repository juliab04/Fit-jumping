...
{{--                    <h2 class="main__list-heading ss-heading"></h2>--}}
            ...
            <div class="main__cards-container">
                ...
                <ul class="main__cards">
                    ...
                    <li class="main__card" style="--hue: 231;">
                        ...
                        <h3 class="main__card-heading">{{$coach->name}}</h3>
                        <p class="main__card-heading-sub">{{$coach->description}}</p>
                        <p class="main__card-heading-sub">Возраст:{{$coach->age}}</p>
                        <p class="main__card-heading-sub">Пол:{{$coach->gender}}</p>
                        <p class="main__card-heading-sub">Стаж работы:{{$coach->seniority}}</p>
                    </li>
                    @endforeach
                </ul>
