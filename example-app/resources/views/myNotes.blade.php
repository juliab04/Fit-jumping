...
<div class="dash">
    ...
    <header class="header">
        ...
        <div class="header__options">
            <a href="getNotes" class="header__link">Edit</a>
                ...
                <ul class="main__cards">
                    @foreach($groups as $group)
                        <li class="main__card" style="--hue: 231;">
                            ...
                            <h3 class="main__card-heading" id="name">{{$group->name}}</h3>
                            <p class="main__card-heading-sub" id="description">{{$group->description}}</p>
                            <p class="main__card-heading-sub" id="price">Цена:{{$group->price}}</p>
                            <p class="main__card-heading-sub" id="number_of_lessons">Количество занятий:{{$group->number_of_lessons}}</p>
                            <p class="main__card-heading-sub" id="max_number_of_participants">Максимальное количество участников:{{$group->max_number_of_participants}}</p>
                            <p class="main__card-heading-sub" id="actual_number_of_participants">Фактическое количество участников:{{$group->actual_number_of_participants}}</p>

                            <form action="/deleteNote" method="post">
                                @csrf
                                <input type="submit" name="group_id"  value="{{$group->id}}"/>
                            </form>
